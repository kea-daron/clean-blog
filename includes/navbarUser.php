      ...
      <div class="hidden items-center gap-4 md:flex">
        <div class="flex items-center space-x-4">
          ...
          <button id="theme-toggle" class="rounded-md border border-primary-100 dark:bg-back dark:border-primary-100 p-2 dark:text-primary-100 text-primary-50">
            ...
            <!-- Moon icon -->
            <svg id="moon-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
            </svg>
          </button>
          <a href="../pages/userProfile.php?prof_id=<?php echo $_SESSION['user_id']; ?>"><button class="rounded-md font-semibold text-white px-4 py-1.5 bg-blue-900 px-4 text-primary-50 border-2 border-primary-100 hover:bg-primary-100 hover:text-primary-50 dark:bg-blue-900 dark:text-white dark:hover:bg-yellow-500" data-translate="profile">Profile</button></a>
          <a href="../auth/logout.php"><button class="rounded-md font-semibold bg-primary-100 px-4 py-1.5 text-white border-2 border-primary-100 hover:bg-blue-900 dark:bg-yellow-500 dark:hover:bg-blue-900 dark:text-white" data-translate="log-out">Log out</button></a>
