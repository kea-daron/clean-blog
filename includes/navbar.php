  ...
  <header class="sticky top-0 z-50 w-full border-b bg-blue-900 dark:bg-blue-900 dark:border-gray-700 transition-colors duration-200">
    <div class="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="hidden items-center gap-4 md:flex">
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            ...
            <button
              ...
              <img
                ...
                alt="Khmer"
                class="w-full h-full object-cover border-2 border-yellow-500" />
            </button>
          </div>
          ...
          <a href="../auth/register.php"><button class="rounded-md font-semibold text-white px-4 py-1.5 bg-blue-900 px-4 text-primary-50 border-2 border-primary-100 hover:bg-primary-100 hover:text-primary-50 dark:bg-blue-900 dark:text-white dark:hover:bg-yellow-500" data-translate="register">Register</button></a>
          <a href="../auth/login.php"><button class="rounded-md font-semibold bg-primary-100 px-4 py-1.5 text-white border-2 border-primary-100 hover:bg-blue-900 dark:bg-yellow-500 dark:hover:bg-blue-900 dark:text-white" data-translate="log-in">Log in</button></a>
        </div>
      ...
      <div class="flex items-center gap-4 md:hidden">
        ...
        <button id="mobile-theme-toggle" class="rounded-md border border-primary-100 dark:border-primary-100 dark:bg-gray-900  p-2 text-primary-50 dark:text-primary-100">
          ...
          <!-- Moon icon -->
          <svg id="mobile-moon-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div id="mobile-menu" class="fixed inset-y-0 right-0 w-[80%] max-w-sm bg-white dark:bg-gray-900 shadow-lg z-50 transform translate-x-full transition-transform duration-300 ease-in-out">
      ...
      <!-- <div class="flex flex-col gap-2 p-6">
        <a href="/" class="text-white dark:text-white font-medium text-lg" data-translate="home">Home</a>
