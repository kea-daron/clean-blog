    ...
    <div class="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <!-- <div class="relative" id="language-dropdown">
          <button id="language-dropdown-btn" class="flex items-center gap-1 rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm dark:text-gray-300">
            <span class="mr-1 text-base" id="current-flag"></span>
            <span id="current-language">English</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
              <path d="m6 9 6 6 6-6"/>
            </svg>
          </button>
          <div id="language-menu" class="absolute right-0 mt-1 w-36 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-lg hidden">
            <div class="py-1">
              <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-300" data-lang="en" data-flag="">
                <span class="mr-2 text-base">English</span> 
              </a>
