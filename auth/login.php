        ...
        <div class="md:w-1/2 p-6 flex items-center justify-center w-full h-full">
            ...
            <div class="w-full max-w-md"> 
                ...
                <form method="POST" action="login.php" class="space-y-4 mt-5">
                    ...
                    <p class="text-gray-700 text-sm text-center">Don't have an account? <a href="http://localhost/clean-blog/auth/register.php" class="text-blue-600 font-semibold">Sign now</a></p>
                </form>
            </div>
        </div>
    </div>
